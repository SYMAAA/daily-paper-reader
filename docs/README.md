...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-12 21:08:41 UTC<br>状态：成功</p>
</section>
...
<p>精读：《CoVeR: Coverage-Based Token Pruning for Multi-View 3D Reasoning in VLMs》（8.0/10）</p>
<p>速读：《LILA: Calibration-Free Structured Pruning of Large Language Models via Latent Spectral Geometry》（7.0/10）, 《DSE-VTG: Dual-Side Enhancement for Training-Free Video Temporal Grounding》（6.0/10）, 《EFQ-Softmax: Exp-Free Quantization for Softmax》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="CoVeR: Coverage-Based Token Pruning for Multi-View 3D Reasoning in VLMs">CoVeR: Coverage-Based Token Pruning for Multi-View 3D Reasoning in VLMs</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="LILA: Calibration-Free Structured Pruning of Large Language Models via Latent Spectral Geometry">LILA: Calibration-Free Structured Pruning of Large Language Models via Latent Spectral Geometry</span></li><li><span class="dpr-home-dashboard-paper-title" title="DSE-VTG: Dual-Side Enhancement for Training-Free Video Temporal Grounding">DSE-VTG: Dual-Side Enhancement for Training-Free Video Temporal Grounding</span></li><li><span class="dpr-home-dashboard-paper-title" title="EFQ-Softmax: Exp-Free Quantization for Softmax">EFQ-Softmax: Exp-Free Quantization for Softmax</span></li></ul>
  </div>
